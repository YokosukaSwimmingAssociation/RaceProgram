...
Sub 学マプログラム補正改()
    ...
    Call ModCell(SearchCell(19, "冨田　清雄", "レーン"), "5") '"F48"
    Call ModCell(SearchCell(19, "小杉　邦洋", "レーン"), "6") '"F49"
    ...
    Call ModCell(SearchCell(19, "児玉　　暢", "レーン"), "5") ' "F52"
    Call ModCell(SearchCell(19, "南　　清志", "レーン"), "6") ' "F53"
